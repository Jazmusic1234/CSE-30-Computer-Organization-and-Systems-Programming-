 ...
 * UserId: cs30xax
 * Date: 4/4/2019
 * Sources of Help: write up, Notes #2
 */

@ Raspberry Pi directives
	.cpu	cortex-a53	@ Version of out Pis
 ...
 * Description: Returns the integer average of the three formal paramenters
 * Parameters: a - the first value to sum
 	       b - the second vlaue to sum
	       c - the third value to sum
 * Side Effects: None
 * Error Conditions: None
 * Return Value: The average fo the three formal parameters
 *
 * Registers used:
 *     r0 - arg 1 -- a
...
@ Standard prologue
	...
	add	r3, r3, r2		@ Add param3 to param1 and param2 ; result into r3
